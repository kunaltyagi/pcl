...
void
ON_SortFloatArray (ON::sort_algorithm sort_algorithm, float *a, size_t nel)
{
  if (ON::heap_sort == sort_algorithm)
...
void
ON_SortUnsignedIntArray (ON::sort_algorithm sort_algorithm, unsigned int *a, size_t nel)
{
  if (ON::heap_sort == sort_algorithm)
    ON_hsort_uint (a, nel);
  else
