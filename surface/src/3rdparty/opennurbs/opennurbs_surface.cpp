                    ...
                    if (!(D1a - D1b).IsTiny (D1b.MaximumCoordinate () *
                      ...
                      *t = t1;
                      rc = true;
                               ...
                               !(D2a - D2b).IsTiny (D2b.MaximumCoordinate () *
                                                    ON_SQRT_EPSILON)) {
                      if (dtype)
                        *dtype = 2;
                      *t = t1;
...
// virtual
bool
ON_Surface::Extend (int dir, const ON_Interval &domain)
{
  return false;
}
...
// virtual
int
ON_Surface::GetNurbForm (ON_NurbsSurface &nurbs_surface, double tolerance) const
{
  return 0;
}
