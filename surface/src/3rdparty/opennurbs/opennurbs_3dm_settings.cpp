...
ON_3dmUnitsAndTolerances::ON_3dmUnitsAndTolerances ()
    : m_absolute_tolerance (0.0), m_angle_tolerance (0.0), m_relative_tolerance (0.0),
      m_distance_display_mode (ON::decimal), m_distance_display_precision (3)
{
  Default ();
}
...
void
ON_3dmAnnotationSettings::Dump (ON_TextLog &text_log) const
{
  // TODO
}
...
void
ON_3dmConstructionPlane::Dump (ON_TextLog &text_log) const
{
  // TODO
}
...
ON_3dmConstructionPlaneGridDefaults &
ON_3dmConstructionPlaneGridDefaults::
operator= (const ON_3dmConstructionPlaneGridDefaults &src)
{
  if (this != &src) {
    m_grid_spacing = src.m_grid_spacing;
    m_snap_spacing = src.m_snap_spacing;
...
void
ON_3dmConstructionPlaneGridDefaults::Dump (ON_TextLog &text_log) const
{
  // TODO
}
