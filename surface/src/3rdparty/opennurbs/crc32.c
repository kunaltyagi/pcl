 ...
 */
const unsigned int FAR *ZEXPORT
get_crc_table ()
{
#ifdef DYNAMIC_CRC_TABLE
  if (crc_table_empty)
...
/* ========================================================================= */
unsigned int ZEXPORT crc32 (crc, buf, len) unsigned int crc;
...
/* ========================================================================= */
local unsigned int crc32_little (crc, buf, len) unsigned int crc;
const unsigned char FAR *buf;
unsigned len;
{
  register u4 c;
...
/* ========================================================================= */
local unsigned int crc32_big (crc, buf, len) unsigned int crc;
const unsigned char FAR *buf;
unsigned len;
{
  register u4 c;
...
/* ========================================================================= */
local unsigned int gf2_matrix_times (mat, vec) unsigned int *mat;
unsigned int vec;
{
  unsigned int sum;
...
/* ========================================================================= */
local void gf2_matrix_square (square, mat) unsigned int *square;
unsigned int *mat;
{
  int n;
