...
void *
ON_FixedSizePool::FirstElement (size_t element_index)
{
  const char *block;
...
void *
ON_FixedSizePoolIterator::FirstElement (size_t element_index)
{
  const char *block;
  const char *block_end;
  const char *next_block;
...
void *
ON_FixedSizePool::FirstBlock (size_t *block_element_count)
{
  if (m_first_block && m_total_element_count > 0) {
    m_qwerty_it_block = m_first_block;
    m_qwerty_it_element =
...
void *
ON_FixedSizePoolIterator::FirstBlock (size_t *block_element_count)
{
  if (m_fsp.m_first_block && m_fsp.m_total_element_count > 0) {
    m_it_block = m_fsp.m_first_block;
    m_it_element = (void *)(((char *)m_it_block) +
...
void *
ON_FixedSizePool::NextBlock (size_t *block_element_count)
{
  if (0 != m_qwerty_it_block && m_qwerty_it_block != m_al_block &&
    ...
    if (m_qwerty_it_block == m_al_element_array) {
      ...
      m_qwerty_it_element =
          (void *)(((char *)m_qwerty_it_block) +
                   2 * sizeof (void *)); // m_qwerty_it_element points to first element
                                         // in m_first_block
      if (0 != block_element_count)
        *block_element_count = BlockElementCount (m_qwerty_it_block);
    }
...
void *
ON_FixedSizePoolIterator::NextBlock (size_t *block_element_count)
{
...
void *
ON_FixedSizePool::Element (size_t element_index) const
{
  const char *block;
  const char *block_end;
  const char *next_block;
