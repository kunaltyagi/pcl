...
ON_UuidIndexList::ON_UuidIndexList (int capacity)
    : ON_SimpleArray<ON_UuidIndex> (capacity > 32 ? capacity : 32), m_sorted_count (0),
      m_removed_count (0)
{
}
...
ON_UuidPairList::ON_UuidPairList (int capacity)
    : ON_SimpleArray<ON_UuidPair> (capacity > 32 ? capacity : 32), m_sorted_count (0),
      m_removed_count (0)
{
}
...
const ON_2dex *
ON_BinarySearch2dexArray (int key_i, const ON_2dex *base, size_t nel)
{
  if (nel > 0 && base) {
    size_t i;
    int base_i;
