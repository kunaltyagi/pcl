...
const char *
ON_DecodeBase64::Decode (const char *base64str, size_t base64str_count)
{
  char *sEnd;
  const char *p;
  char s[1025];
...
const wchar_t *
ON_DecodeBase64::Decode (const wchar_t *base64str, size_t base64str_count)
{
  char *sEnd;
  const char *p;
  char s[1025];
...
ON_Base64EncodeStream::ON_Base64EncodeStream ()
    : m_out_callback_function (0), m_out_callback_context (0), m_in_size (0),
      m_out_size (0), m_in_crc (0), m_out_crc (0), m_implementation (0), m_reserved (0)
{
}
