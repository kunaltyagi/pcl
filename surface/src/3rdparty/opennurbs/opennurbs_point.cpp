...
ON_2fPoint ON_2fPoint::operator* (int d) const { return ON_2fPoint (x * d, y * d); }

ON_2fPoint ON_2fPoint::operator* (float d) const { return ON_2fPoint (x * d, y * d); }

ON_2dPoint ON_2fPoint::operator* (double d) const { return ON_2dPoint (x * d, y * d); }
...
float ON_2fPoint::operator* (const ON_2fPoint &h) const { return x * h.x + y * h.y; }

float ON_2fPoint::operator* (const ON_2fVector &h) const { return x * h.x + y * h.y; }
...
float ON_2fPoint::operator[] (unsigned int i) const { return (i <= 0) ? x : y; }
...
ON_3fPoint::operator<= (const ON_3fPoint &p) const
{
  ...
  return ((x < p.x)
              ? true
              : ((x == p.x) ? ((y < p.y) ? true : (y == p.y && z <= p.z) ? true : false)
                            : false));
}
...
ON_2fVector ON_2fVector::operator* (int d) const { return ON_2fVector (x * d, y * d); }
...
float ON_2fVector::operator* (const ON_2fPoint &v) const { return (x * v.x + y * v.y); }
...
float ON_2fVector::operator* (const ON_4fPoint &h) const { return x * h.x + y * h.y; }
...
float ON_2fVector::operator[] (unsigned int i) const { return ((i <= 0) ? x : y); }
...
ON_3fVector::operator<= (const ON_3fVector &v) const
{
  ...
  return ((x < v.x)
              ? true
              : ((x == v.x) ? ((y < v.y) ? true : (y == v.y && z <= v.z) ? true : false)
                            : false));
}
...
ON_2dPoint ON_2dPoint::operator* (double d) const { return ON_2dPoint (x * d, y * d); }
...
double ON_2dPoint::operator* (const ON_2dPoint &h) const { return x * h.x + y * h.y; }

double ON_2dPoint::operator* (const ON_2dVector &h) const { return x * h.x + y * h.y; }
...
double ON_2dPoint::operator[] (unsigned int i) const { return (i <= 0) ? x : y; }
...
double ON_2dVector::operator* (const ON_4dPoint &h) const { return x * h.x + y * h.y; }
...
double ON_2dVector::operator[] (unsigned int i) const { return ((i <= 0) ? x : y); }
