...
ON_BOOL32
ON_Curve::ChangeClosedCurveSeam (double t)
{
...
int
ON_Curve::IsPolyline (ON_SimpleArray<ON_3dPoint> *pline_points, // default = NULL
...
bool
ON_Brep::EvaluatePoint (const class ON_ObjRef &objref, ON_3dPoint &P) const
{
  // TODO
  return false;
}
...
bool
ON_Surface::EvaluatePoint (const class ON_ObjRef &objref, ON_3dPoint &P) const
{
  // TODO
  return false;
}
...
bool
ON_PolyCurve::EvaluatePoint (const class ON_ObjRef &objref, ON_3dPoint &P) const
{
  // TODO
  return false;
}
...
ON_BOOL32
ON_Curve::Trim (const ON_Interval &in)
{
...
bool
ON_Curve::Extend (const ON_Interval &domain)
