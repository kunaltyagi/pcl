...
void *
ON_Workspace::GetMemory (size_t size)
{
  void *p = NULL;
  if (size > 0) {
...
void *
ON_Workspace::GrowMemory (void *p, size_t size)
{
  void *newp = NULL;
  if (!p) {
    newp = GetMemory (size);
...
int *
ON_Workspace::GetIntMemory (size_t size)
{
...
double *
ON_Workspace::GetDoubleMemory (size_t size)
{
...
ON_3dPoint *
ON_Workspace::GetPointMemory (size_t size)
{
...
ON_3dVector *
ON_Workspace::GetVectorMemory (size_t size)
{
...
int **
ON_Workspace::GetIntMemory (size_t row_count, size_t col_count)
{
  int **p = 0;
  size_t i;
...
double **
ON_Workspace::GetDoubleMemory (size_t row_count, size_t col_count)
{
  double **p = 0;
  size_t i;
  if (row_count > 0 && col_count > 0) {
...
int *
ON_Workspace::GrowIntMemory (int *p, size_t size)
{
...
double *
ON_Workspace::GrowDoubleMemory (double *p, size_t size)
{
...
ON_3dPoint *
ON_Workspace::GrowPointMemory (ON_3dPoint *p, size_t size)
{
...
ON_3dVector *
ON_Workspace::GrowVectorMemory (ON_3dVector *p, size_t size)
{
