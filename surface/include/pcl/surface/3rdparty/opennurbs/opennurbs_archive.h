...
class ON_CLASS ON_BinaryArchive // use for generic serialization of binary data
{
  ...
  */
  ...
  static char *
  ON_TypecodeParse (unsigned int tcode, char *typecode_name, size_t max_length);
  ...
  */
  ...
  bool
  ReadByte (size_t, void *); // must fail if mode is not read or readwrite

  bool
  WriteByte (size_t, const void *); // must fail if mode is not write or readwrite
  ...
  */
  bool
  ReadCompressedBufferSize (size_t *sizeof__outbuffer);
  ...
  */
  bool
  ReadCompressedBuffer (size_t sizeof__outbuffer, void *outbuffer, int *bFailedCRC);
  ...
  */
  bool
  WriteCompressedBuffer (size_t sizeof__inbuffer, const void *inbuffer);
  ...
  ReadLong ( // Read a single 32 bit unsigned integer
      unsigned long *);
  bool
  ReadSize ( // Read a single size_t
      size_t *);

  bool
  ReadBigSize (size_t *); // 64 bits
  ...
  */
  ON_DEPRECATED bool
  ReadStringSize (size_t *str_array_count);
  ...
  */
  bool
  ReadStringUTF8ElementCount (size_t *string_utf8_element_count);
  ...
  */
  bool
  ReadStringUTF16ElementCount (size_t *string_utf16_element_count);
  ...
  */
  bool
  ReadString (size_t str_array_count, char *str_array);
  ...
  */
  bool
  ReadString (size_t str_array_count, unsigned char *str_array);
  ...
  */
  bool
  ReadString (size_t str_array_count, unsigned short *str_array);
  ...
  */
  ...
  bool
  Read3dmEndMark (size_t * // sizeof_archive
  );
  ...
  */
  ...
  // 16 bit integer IO
  bool
  WriteInt8 (size_t, const ON__INT8 *);
  bool
  ReadInt8 (size_t, ON__INT8 *);

  // 16 bit integer IO
  bool
  WriteInt16 (size_t, const ON__INT16 *);
  bool
  ReadInt16 (size_t, ON__INT16 *);

  // 32 bit integer IO
  bool
  WriteInt32 (size_t, const ON__INT32 *);
  bool
  ReadInt32 (size_t, ON__INT32 *);

  // 64 bit integer IO
  bool
  WriteInt64 (size_t, const ON__INT64 *);
  bool
  ReadInt64 (size_t, ON__INT64 *);
  ...
  */
  ...
  size_t
  WriteDeflate (size_t,      // sizeof uncompressed input data
                const void * // uncompressed input data
  );
  bool
  ReadInflate (size_t, // sizeof uncompressed input data
...
class ON_CLASS ON_Read3dmBufferArchive : public ON_BinaryArchive
{
  ...
  */
  ...
  // ON_BinaryArchive overrides
  size_t
  Read (size_t, void *); // return actual number of bytes read (like fread())
  size_t
  Write (size_t, const void *);
  bool
  Flush ();
...
class ON_CLASS ON_Write3dmBufferArchive : public ON_BinaryArchive
{
  ...
  */
  ...
  Read (size_t, void *);
  size_t
  Write (size_t, const void *); // return actual number of bytes written (like fwrite())
  bool
  Flush ();
