...
class ON_CLASS ON_Workspace
{
  ...
  */
  int **
  GetIntMemory (size_t row_count, size_t col_count);
  ...
  */
  double **
  GetDoubleMemory (size_t row_count, size_t col_count);
  ...
  */
  int *
  GrowIntMemory (int *ptr, size_t count);
  ...
  */
  double *
  GrowDoubleMemory (double *ptr, size_t count);
  ...
  */
  ON_3dPoint *
  GrowPointMemory (ON_3dPoint *ptr, size_t count);
  ...
  */
  ON_3dVector *
  GrowVectorMemory (ON_3dVector *ptr, size_t count);
