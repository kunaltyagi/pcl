...
ON_DECL
void
ON_SortDoubleArray (ON::sort_algorithm sort_algorithm, double *a, size_t nel);
...
ON_DECL
void
ON_SortIntArray (ON::sort_algorithm sort_algorithm, int *a, size_t nel);
...
ON_DECL
void
ON_SortStringArray (ON::sort_algorithm sort_algorithm, char **a, size_t nel);

ON_DECL
const int *
ON_BinarySearchIntArray (int key, const int *base, size_t nel);
...
ON_DECL
const double *
ON_BinarySearchDoubleArray (double key, const double *base, size_t nel);
...
class ON_CLASS ON_CheckSum
{
  ...
  */
  bool
  SetBufferCheckSum (size_t size, const void *buffer, time_t time);
  ...
  */
  bool
  CheckBuffer (size_t size, const void *buffer) const;
