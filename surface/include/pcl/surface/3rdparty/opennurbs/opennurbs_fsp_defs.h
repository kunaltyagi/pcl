...
template <class T>
T *
ON_SimpleFixedSizePool<T>::FirstBlock (size_t *block_element_count)
{
...
template <class T>
T *
ON_SimpleFixedSizePool<T>::NextBlock (size_t *block_element_count)
{
...
template <class T>
T *
ON_SimpleFixedSizePool<T>::Element (size_t element_index) const
{
