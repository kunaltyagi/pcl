...
inline pcl::recognition::SimpleOctree<NodeData, NodeDataCreator, Scalar>::Node::Node ()
...
template <typename NodeData, typename NodeDataCreator, typename Scalar>
inline void
pcl::recognition::SimpleOctree<NodeData, NodeDataCreator, Scalar>::Node::setCenter (
    const Scalar *c)
{
  center_[0] = c[0];
  center_[1] = c[1];
...
template <typename NodeData, typename NodeDataCreator, typename Scalar>
inline void
pcl::recognition::SimpleOctree<NodeData, NodeDataCreator, Scalar>::Node::setBounds (
    const Scalar *b)
{
  bounds_[0] = b[0];
  bounds_[1] = b[1];
...
template <typename NodeData, typename NodeDataCreator, typename Scalar>
inline void
pcl::recognition::SimpleOctree<NodeData, NodeDataCreator, Scalar>::Node::makeNeighbors (
    Node *node)
{
...
template <typename NodeData, typename NodeDataCreator, typename Scalar>
inline void
pcl::recognition::SimpleOctree<NodeData, NodeDataCreator, Scalar>::build (
...
inline
    ...
    pcl::recognition::SimpleOctree<NodeData, NodeDataCreator, Scalar>::createLeaf (
...
inline
    typename pcl::recognition::SimpleOctree<NodeData, NodeDataCreator, Scalar>::Node *
    pcl::recognition::SimpleOctree<NodeData, NodeDataCreator, Scalar>::getFullLeaf (
        int i, int j, int k)
{
...
template <typename NodeData, typename NodeDataCreator, typename Scalar>
inline void
pcl::recognition::SimpleOctree<NodeData, NodeDataCreator, Scalar>::insertNeighbors (
    Node *node)
{
