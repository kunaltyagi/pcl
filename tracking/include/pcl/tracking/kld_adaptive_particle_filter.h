...
namespace pcl
{
  namespace tracking
  {
    ...
    /** \brief @b KLDAdaptiveParticleFilterTracker tracks the PointCloud which is given
      by setReferenceCloud within the measured PointCloud using particle filter method.
        The number of the particles changes adaptively based on KLD sampling [D. Fox,
      NIPS-01], [D.Fox, IJRR03].
      * \author Ryohei Ueda
      * \ingroup tracking
      */
        ...
        : public ParticleFilterTracker<PointInT, StateT>
    {
      ...
      /** \brief resampling phase of particle filter method.
          ...
          in particular, "sample with replacement" is archieved by walker's alias
         method.
        */
      void
      resample () override;
