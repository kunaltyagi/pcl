...
namespace pcl
{
  ...
  namespace tracking
  {
    ...
    /** \brief @b PointCoherence is a base class to compute coherence between the two
     * points. \author Ryohei Ueda \ingroup tracking
     */
    ...
    /** \brief @b PointCloudCoherence is a base class to compute coherence between the
     * two PointClouds. \author Ryohei Ueda \ingroup tracking
     */
    template <typename PointInT>
    class PointCloudCoherence
    {
      ...
      computeCoherence (const PointCloudInConstPtr &cloud,
                        const IndicesConstPtr &indices, float &w_j) = 0;
