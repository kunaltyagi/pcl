...
ICCVTutorial<FeatureType>::ICCVTutorial (
    ...
    : source_keypoints_ (new pcl::PointCloud<pcl::PointXYZI> ()),
      ...
      keypoint_detector_ (keypoint_detector), feature_extractor_ (feature_extractor),
    ...
    typename pcl::PointCloud<FeatureType>::Ptr features)
{
  ...
  // if (boost::dynamic_pointer_cast<typename pcl::FeatureFromNormals<pcl::PointXYZRGB,
