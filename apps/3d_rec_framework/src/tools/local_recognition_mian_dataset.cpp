    ...
    bool single_model = false)
{
  ...
  typename boost::shared_ptr<pcl::rec_3d_framework::Source<PointT>> model_source_ =
      local.getDataSource ();
...
main (int argc, char **argv)
{
  ...
  boost::shared_ptr<pcl::rec_3d_framework::MeshSource<pcl::PointXYZ>> mesh_source (
  ...
  cast_source =
      boost::static_pointer_cast<pcl::rec_3d_framework::MeshSource<pcl::PointXYZ>> (
          mesh_source);
  ...
  boost::shared_ptr<pcl::CorrespondenceGrouping<pcl::PointXYZ, pcl::PointXYZ>>
      cast_cg_alg;
  boost::shared_ptr<pcl::GeometricConsistencyGrouping<pcl::PointXYZ, pcl::PointXYZ>>
  ...
  boost::shared_ptr<pcl::GlobalHypothesesVerification<pcl::PointXYZ, pcl::PointXYZ>>
      go (new pcl::GlobalHypothesesVerification<pcl::PointXYZ, pcl::PointXYZ>);
  ...
  boost::shared_ptr<pcl::GreedyVerification<pcl::PointXYZ, pcl::PointXYZ>> greedy (
  ...
  if (desc_name == "shot") {
    ...
    boost::shared_ptr<
        ...
        cast_estimator;
    cast_estimator = boost::dynamic_pointer_cast<
        pcl::rec_3d_framework::LocalEstimator<pcl::PointXYZ, pcl::Histogram<352>>> (
        estimator);
