...
namespace pcl
{
  namespace rec_3d_framework
  {
    ...
    class LocalEstimator
    {
      ...
      typename boost::shared_ptr<PreProcessorAndNormalEstimator<PointInT, pcl::Normal>>
          normal_estimator_;
      ...
      void
      setNormalEstimator (
          boost::shared_ptr<PreProcessorAndNormalEstimator<PointInT, pcl::Normal>> &ne)
      {
      ...
      void
      setKeypointExtractors (
          std::vector<typename boost::shared_ptr<KeypointExtractor<PointInT>>> &ke)
      {
