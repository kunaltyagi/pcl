...
namespace pcl
{
  namespace rec_3d_framework
  {
     ...
     * FLANN is used to identify a neighborhood, based on which different scoring
     * schemes can be employed to obtain likelihood values for a specified list of
     * classes. Available features: ESF, VFH, CVFH \author Aitor Aldoma
     */
    ...
    class PCL_EXPORTS GlobalNNCRHRecognizer
    {
      ...
      void
      setHVAlgorithm (
          typename boost::shared_ptr<HypothesisVerification<PointInT, PointInT>> &alg)
      {
        hv_algorithm_ = alg;
      }
