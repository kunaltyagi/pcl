...
namespace pcl
{
  namespace rec_3d_framework
  {
     ...
     * verification Available features: SHOT, FPFH See apps/3d_rec_framework/tools/apps
     * for usage \author Aitor Aldoma, Federico Tombari
     */
    ...
    class PCL_EXPORTS LocalRecognitionPipeline
    {
      ...
      void
      setCGAlgorithm (
          typename boost::shared_ptr<CorrespondenceGrouping<PointInT, PointInT>> &alg)
      {
        cg_algorithm_ = alg;
      }
