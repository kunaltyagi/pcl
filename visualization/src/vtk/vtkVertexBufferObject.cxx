...
//----------------------------------------------------------------------------
vtkVertexBufferObject::~vtkVertexBufferObject () { this->SetContext (nullptr); }

//----------------------------------------------------------------------------
// Description:
// Returns if the context supports the required extensions.
bool
vtkVertexBufferObject::IsSupported (vtkRenderWindow *win)
{
...
//----------------------------------------------------------------------------
bool
vtkVertexBufferObject::LoadRequiredExtensions (vtkOpenGLExtensionManager *mgr)
{
...
//----------------------------------------------------------------------------
void
vtkVertexBufferObject::SetContext (vtkRenderWindow *renWin)
{
...
void
vtkVertexBufferObject::SetAttributeNormalized (bool normalized)
{
  if (normalized) {
...
//----------------------------------------------------------------------------
int
vtkVertexBufferObject::GetDataTypeSize (int type)
{
  switch (type) {
    vtkTemplateMacro (return sizeof (static_cast<VTK_TT> (0)));
...
//----------------------------------------------------------------------------
bool
vtkVertexBufferObject::Upload (vtkPoints *points)
{
  ...
  this->Size =
      this->Count * this->AttributeSize * GetDataTypeSize (points->GetDataType ());
...
//----------------------------------------------------------------------------
bool
vtkVertexBufferObject::Upload (vtkCellArray *verts)
{
  vtkIdType npts;
  vtkIdType *pts;
...
//----------------------------------------------------------------------------
bool
vtkVertexBufferObject::Upload (unsigned int *indices, unsigned int count)
{
  this->Count = count;
  this->AttributeSize = 1;
  this->AttributeType = GL_INT;
...
//----------------------------------------------------------------------------
bool
vtkVertexBufferObject::UploadNormals (vtkDataArray *normals)
{
...
//----------------------------------------------------------------------------
bool
vtkVertexBufferObject::UploadColors (vtkDataArray *colors)
{
...
//----------------------------------------------------------------------------
bool
vtkVertexBufferObject::Upload (vtkDataArray *array)
{
  ...
  this->Size = this->Count * array->GetNumberOfComponents () *
               GetDataTypeSize (array->GetDataType ());
  this->BufferTarget = vtkgl::ARRAY_BUFFER;
...
//----------------------------------------------------------------------------
bool
vtkVertexBufferObject::Upload (vtkDataArray *array, int attributeType, int arrayType)
{
  ...
  this->Size =
      this->Count * this->AttributeSize * GetDataTypeSize (array->GetDataType ());
  this->BufferTarget = vtkgl::ARRAY_BUFFER;
...
//----------------------------------------------------------------------------
bool
vtkVertexBufferObject::Upload (vtkUnsignedCharArray *colors)
{
  ...
  this->AttributeType = GL_UNSIGNED_BYTE;
  this->Size =
      this->Count * this->AttributeSize * GetDataTypeSize (colors->GetDataType ());
  this->BufferTarget = vtkgl::ARRAY_BUFFER;
  this->ArrayType = GL_COLOR_ARRAY;
...
//----------------------------------------------------------------------------
bool
vtkVertexBufferObject::Upload (GLvoid *data)
{
  if (!this->Context) {
...
//----------------------------------------------------------------------------
void
vtkVertexBufferObject::PrintSelf (ostream &os, vtkIndent indent)
{
